  ...
  return (
    <div className="w-screen h-screen bg-blue-700-500 flex justify-left items-center bg-red-500 md:bg-red-50 w-500 h-500 md:bg-brown-500  ">
      <div classname="relative">
          ...
          alt="..."
        ></img>  
        <p className="absolute top-60 text-orange-900 text-2xl z-10 flex font-mono  font-bold text-8xl ... text-slate-300 left-9 ">Foodies</p>
        <p className="absolute top-65 text-3xl z-10 flex font-mono	text-base/6 ... text-orange-900 items-center  antialiased ... left-9  font-bold" >  Online, easy and beautiful.</p>
